...
1. Pick your starting city.
2. Optionally pick the job you're leveling to see its class/job quests nested in the MSQ.
3. Check quests off as you go. Progress saves automatically in your browser.

Saved progress is **per-device** — it won't sync across devices.
